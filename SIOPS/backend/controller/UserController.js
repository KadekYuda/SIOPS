        ...
        try {
          ...
          res.status(200).json({
            ...
            user: {
              ...
              phone_number: req.userData.phone_number || null,
    ...
    export const updateUser = async (req, res) => {
        ...
        try {
          ...
          user.phone_number = phone_number || user.phone_number; // Handle null/undefined
          ...
          await user.save();
          await user.reload(); // Ambil data terbaru dari database
