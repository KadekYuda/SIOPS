...
const EnterprisePortalCard = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-700 via-indigo-500 to-purple-600 dark:from-purple-900 dark:via-indigo-900 dark:to-blue-900 text-white p-8 rounded-3xl shadow-lg w-full">
      {/* Header with Icon */}
      <div className="flex flex-col items-center mb-8">
        <div className="w-20 h-20 bg-blue-950/30 rounded-full flex items-center justify-center backdrop-blur-sm mb-6">
...
const Login = ({ onLoginSuccess }) => {
  ...
  <motion.div
    ...
    className="w-20 h-20 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
  >
