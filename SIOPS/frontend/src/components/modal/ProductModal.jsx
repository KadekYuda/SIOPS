      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-4 sm:p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-white rounded-t-xl gap-4 sm:gap-2">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onClose}
              className="p-2 rounded-full hover:bg-gray-100 transition-colors hidden sm:block ml-4"
              aria-label="Close"
            >
              <X size={20} className="text-gray-500" />
            </button>
          ...
          {csvMode ? (
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                {/* Supported Formats */}
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-4 sm:p-5 shadow-sm">
                ...
                {/* Tips for Success */}
                <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-lg p-4 sm:p-5 shadow-sm">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <ul className="text-xs sm:text-sm text-green-700 space-y-1.5">
                        ...
                        <li className="flex items-start">
                          <span className="w-1.5 h-1.5 bg-green-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                          <span>Use dots (.) for decimal prices</span>
                        </li>
                        <li className="flex items-start">
                          <span className="w-1.5 h-1.5 bg-green-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                          <span>Avoid special characters in names</span>
                        </li>
                        <li className="flex items-start">
                          <span className="w-1.5 h-1.5 bg-green-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
